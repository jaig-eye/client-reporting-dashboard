// ─────────────────────────────────────────────────────────────────────────────
// Admin Preview — GA4 Analytics Page
// Mirrors /dashboard/analytics but authenticates via clientId param (no cookie).
// ─────────────────────────────────────────────────────────────────────────────
...
export default async function PreviewGA4Page({
  params,
  searchParams,
}: {
      ...
      <div className="min-h-screen" style={{ background: 'var(--bg-base)' }}>
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          <EmptyState
            ...
            description="Connect the client's GA4 property in Client Settings to see traffic data here."
          />
        </main>
      </div>
    )
