...
export async function GET(request: NextRequest) {
  // verifyCronAuth fails closed when CRON_SECRET is unset (an unset var would
  // otherwise interpolate to the literal "Bearer undefined", which is truthy and
  // would authenticate anyone sending it). Shared with every other cron route.
