...
export default async function CrmPage({
  ...
  // Lead sources: one channel per lead, an ad on either of GHL's attributions first. Days synced before
        ...
        {hasSources && (
          <section className="card p-4 sm:p-6" aria-labelledby="crm-sources-title">
            ...
            <p className="section-desc">
              {sources.paid > 0
                ? `${fmtNum(sources.paid)} of ${fmtNum(sources.total)} ${leadWord(sources.total)} came through one of your ads. `
