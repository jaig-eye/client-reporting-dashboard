...
export const DEFAULT_SETTINGS: AgencySettings = {
  ...
  ad_fuel_cut: 0.20,
  default_lead_action: 'onsite_conversion.lead_grouped',
  default_lead_action_fallback: 'lead',
  default_purchase_action: 'purchase',
  default_purchase_action_fallback: undefined,
  cron_enabled: true,
  app_version: '',
  updated_at: '',
